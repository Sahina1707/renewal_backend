# File: apps/campaign_manager/helpers_whatsapp.py
...
# ... (Twilio client initialization code is fine) ...
try:
    TWILIO_ACCOUNT_SID = settings.TWILIO_ACCOUNT_SID
    TWILIO_AUTH_TOKEN = settings.TWILIO_AUTH_TOKEN
    TWILIO_FROM_NUMBER = settings.TWILIO_PHONE_NUMBER # Your Twilio WhatsApp number
...
def send_whatsapp_message(contact_phone, template_provider_id, custom_params=None):
    ...
    to_number_prefixed = f"whatsapp:{contact_phone_e164}" # <-- Use the new E.164 number
    # --- End of Fix ---

    try:
        # --- 4. Send the API call to Twilio ---
        ...
        return True, None, message_id  # (success, error_msg, message_id)
