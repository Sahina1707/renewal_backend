...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EmailFolder',
            fields=[
                ('customer_type', models.CharField(choices=[('normal', 'Normal'), ('hni', 'HNI (High Net Worth)'), ('super_hni', 'Super HNI'), ('vip', 'VIP')], default='normal', help_text='Customer categorization for support tiers', max_length=20)),
                ('is_escalated', models.BooleanField(default=False)),
                ('escalation_reason', models.TextField(blank=True, null=True)),
                ('escalation_priority', models.CharField(blank=True, choices=[('high', 'High Priority'), ('urgent', 'Urgent Priority'), ('critical', 'Critical Priority')], max_length=20, null=True)),
                ...
                ('escalated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='escalated_emails', to=settings.AUTH_USER_MODEL)),
